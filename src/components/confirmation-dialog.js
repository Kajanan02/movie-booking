...
import {validateConfirmationDialog} from "../utilities/validations";
...
const ConfirmationDialog = () => {
  ...
  const {
    ...
    handleOnBlur,
    initForm
  } = FormHandler(confirmationSuccess, validateConfirmationDialog)
      ...
      <div className="sa-popup">
        <form className={'sa-modal-box-style'} onSubmit={handleSubmit} noValidate>
          ...
          {(confirmationDialog.type && confirmationDialog.type == "request") ?
            ...
            (confirmationDialog.isVisible && <div>
              ...
              <div className="sa-popup-btn mb-3" style={{paddingTop: 16}}>
                ...
                <button
                  ...
                  onClick={()=> dispatch(toggleConfirmationDialog({isVisible: false, onSuccess: true}))}
